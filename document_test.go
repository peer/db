...
func TestListReadableDocuments(t *testing.T) {
	...
	// Two documents on top of the core documents startTestServer already inserted.
	doc1 := newTestDoc()
	doc2 := newTestDoc()
	...
	// Pagination: asking for what comes after the first ID leaves it out and returns the rest.
