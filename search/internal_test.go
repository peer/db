...
func TestDocumentTextSearchQuery(t *testing.T) {
	...
	t.Run("NonEmpty", func(t *testing.T) {
		t.Parallel()
		got := testutils.QueryJSON(t, documentTextSearchQuery("hello", operator.Or, nil))
		//nolint:lll
	...
	t.Run("Empty", func(t *testing.T) {
		t.Parallel()
		got := testutils.QueryJSON(t, documentTextSearchQuery("", operator.Or, nil))
		assert.Equal(t, `{"bool":{}}`, got) //nolint:testifylint
	})

	t.Run("ANDOperator", func(t *testing.T) {
		t.Parallel()
		got := testutils.QueryJSON(t, documentTextSearchQuery("hello", operator.And, nil))
		//nolint:lll
	...
	t.Run("MultiTermAddsPhraseBoost", func(t *testing.T) {
		t.Parallel()
		got := testutils.QueryJSON(t, documentTextSearchQuery("hello world", operator.And, nil))
		//nolint:lll
