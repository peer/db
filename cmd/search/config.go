...
type Config struct {
	...
	Elastic           string `short:"e" placeholder:"URL" default:"http://127.0.0.1:9200" help:"URL of the ElasticSearch instance. Default: ${default}" yaml:"elastic"`
	Development       bool   `short:"d" help:"Run in development mode and proxy unknown requests." yaml:"development"`
	ProxyTo           string `short:"P" placeholder:"URL" default:"http://localhost:3000" help:"Base URL to proxy to in development mode. Default: ${default}" yaml:"proxyTo"`
	TLS               struct {
