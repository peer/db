...
var (
	...
	HasPermissionPropID          = identifier.From(Namespace, "HAS_PERMISSION")
	HasPropertyPropID            = identifier.From(Namespace, "HAS_PROPERTY")
	HasRequestedPermissionPropID = identifier.From(Namespace, "HAS_REQUESTED_PERMISSION")
	HasValueTypePropID           = identifier.From(Namespace, "HAS_VALUE_TYPE")
	IdentifierLinkTemplatePropID = identifier.From(Namespace, "IDENTIFIER_LINK_TEMPLATE")
