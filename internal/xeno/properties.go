...
func Properties() ([]any, errors.E) {
	...
	properties = append(properties,
		...
		property("CATALOGUE_CODE", "catalogue code", "kataloška oznaka", "código de catálogo",
			...
			linkTemplate("https://registry.ccx.example/entry/{identifier}"),
			notTextSearchable(),
		),
	...
	properties = append(properties,
		...
		property("TAXON_CODE", "taxon code", "taksonska oznaka", "código taxonómico", linkTemplate("https://registry.ccx.example/taxon/{identifier}"), notTextSearchable()),
		...
		property("CONTESTED_INDIVIDUALITY_MODE", "contested mode of individuality", "sporni način posameznosti", "modo de individualidade contestado",
			subpropertyOf("HAS_INDIVIDUALITY_MODE"),
			describes(
				"<p>The minority reading of how individual a species is, where the discipline has not settled it.</p>",
				"<p>Manjšinsko branje, kako posamezna je vrsta, kadar stroka o tem ni dosegla soglasja.</p>",
				"<p>A leitura minoritária de quão individual é uma espécie, quando a disciplina ainda não a fixou.</p>",
			),
		),
	...
	properties = append(properties,
		...
		property("ACCESSION_CODE", "accession code", "pristopna oznaka", "código de inventário", linkTemplate("https://collections.ccx.example/object/{identifier}"), notTextSearchable()),
	...
	properties = append(properties,
		...
		property("RESEARCHER_CODE", "researcher code", "oznaka raziskovalca", "código de investigador", linkTemplate("https://registry.ccx.example/person/{identifier}"), notTextSearchable()),
		...
		property("DOI", "DOI", "DOI", "DOI", linkTemplate("https://doi.example/{identifier}"), notTextSearchable()),
