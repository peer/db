...
<template>
  <div
    v-if="disabled"
    class="buttonlink relative rounded-sm text-center leading-tight font-medium uppercase shadow-sm outline-none select-none focus:ring-2 focus:ring-offset-1"
    :class="{
