...
<template>
  <div class="pd-stringfiltersresult flex flex-col" :class="{ 'data-reloading': laterLoad }" :data-url="resultsUrl">
    ...
    <ul ref="el">
      <li v-if="error">
        <i class="pd-stringfiltersresult-error text-error-600">{{ t("common.status.loadingDataFailed") }}</i>
      </li>
