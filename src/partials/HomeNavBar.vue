...
<template>
  ...
  <div class="pd-homenavbar-wrapper pd-navbar-wrapper">
    <div id="navbar" class="pd-homenavbar pd-navbar w-container flex min-h-[var(--pd-navbar-min-height)] grow items-center justify-end gap-x-1 p-1 sm:gap-x-4 sm:p-4">
