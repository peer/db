...
import { CAN_DOWNLOAD, hasPermission } from "@/auth"
...
<template>
  <div class="pd-searchresultsheader flex flex-row gap-x-1 sm:gap-x-4">
    ...
    <div v-if="siteContext.features.downloadButtons && hasPermission(CAN_DOWNLOAD)" class="flex shrink-0 items-center gap-1 rounded-sm bg-slate-200 px-1 py-1">
      <button
