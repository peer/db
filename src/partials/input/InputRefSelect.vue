...
// user interaction yet) and while eager, so it flags only on the lazy blur pass;
// the identifier-shape check is not skipped - a pre-populated or freshly typed
// value that is not a valid identifier should surface immediately.
